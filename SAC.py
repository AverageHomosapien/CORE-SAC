...
#def sac_run(actions=None, obs=None, env_id='MountainCarContinuous-v0', total_runs=50000, run=7): #4 (0.8 reward scale), 6 is updated alpha and betas
def sac_run(actions=None, obs=None, env_id='LunarLanderContinuous-v2', total_runs=500000, run=0):
    ...
    agent = Agent(alpha=0.0007, beta=0.0007, reward_scale=5, env_id=env_id,
                input_dims=obs_space, tau=0.01, max_size=1000000, gamma=0.99,
                env=env, batch_size=256, layer1_size=400, layer2_size=300,
